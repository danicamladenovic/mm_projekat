      ...
      <div class="col-lg-8 col-md-8 col-sm-8">
        <div class="pull-up-box">
          <div class="owl-carousel">
            <?php 
              $post_category = get_theme_mod('film_maker_lite_latest_release_section_category');
              if($post_category){
                $page_query = new WP_Query(array( 'category_name' => esc_html( $post_category ,'film-maker-lite')));?>
                <?php while( $page_query->have_posts() ) : $page_query->the_post(); ?>
                <div class="box">
                  <?php if(has_post_thumbnail()) { ?><?php the_post_thumbnail(); ?><?php } ?>
                  <div class="box-content">
                    <h3 class="title"><?php the_title(); ?></h3>
                    <p class="post mb-0"><?php $excerpt = get_the_excerpt(); echo esc_html( film_maker_lite_string_limit_words( $excerpt,12 ) ); ?></p>
